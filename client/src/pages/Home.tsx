...
const Home:React.FC = () => {
   ...
   function OnTryClick(){
    ...
    .then(response => {
      ...
      (response.data.success) ? console.log('e') :  navigate("/Login") ;
